...
function MarioGame() {
  ...
  this.showInstructions = function() {
    gameUI.writeText('GIFT FOR "MY FRIEND"', 30, 30);
    gameUI.writeText('I just want to say : I LOVE YOU SO MUCH', 30, 60);
  };
  ...
  this.checkElementMarioCollision = function(element, row, column) {
    ...
    if (collisionDirection == 'l' || collisionDirection == 'r') {
      ...
      if (element.type == 2) {
        instructionTick = 0;
        this.showInstructions = function() {
          gameUI.writeText('GIFT FOR "MY FRIEND"', centerPos - 100, height - 300);
        };
        //Coin Box
        score.coinScore++;
